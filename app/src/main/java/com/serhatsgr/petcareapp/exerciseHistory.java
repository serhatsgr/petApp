...
public class exerciseHistory extends AppCompatActivity {
    ...
    private void loadExerciseHistory(String animalId) {
        mFireStore.collection("exercise")
                .whereEqualTo("animalId", animalId) // Use animalId from intent
                .get()
    ...
    private void deleteExercise(String exerciseId) {
        mFireStore.collection("exercise")
                ...
                .addOnSuccessListener(aVoid -> {
                    ...
                    loadExerciseHistory(animalId); // Egzersiz geçmişini yeniden yükle
                })
                .addOnFailureListener(e -> {
